...
<head>
  ...
  <style>
    ...
    .toolbar{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:10px 0}
    a.btn, button.btn{padding:.7rem 1rem;border-radius:12px;border:none;cursor:pointer;text-decoration:none;display:inline-block}
    a.btn{background:#22c55e;color:#08121f;font-weight:700}
    button.btn{background:#334155;color:#e2e8f0}
    table{width:100%;border-collapse:collapse;background:#0b1220;border:1px solid #1e293b;border-radius:16px;overflow:hidden}
    th,td{padding:12px;border-bottom:1px solid #1e293b;text-align:left;vertical-align:middle}
    th{background:#0f172a}
    img{width:56px;height:56px;object-fit:contain;filter:drop-shadow(0 4px 12px rgba(0,0,0,.45))}
    .actions{display:flex;gap:8px;flex-wrap:wrap}
    .btn-secondary{background:#64748b;color:#0b1220;font-weight:700;text-decoration:none;padding:.5rem .75rem;border-radius:10px}
    .btn-danger{background:#ef4444;color:#0b1220;font-weight:700;border:none;border-radius:10px;padding:.5rem .75rem;cursor:pointer}
